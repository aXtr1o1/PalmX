...
export default function ChatInterface() {
    ...
    // Initial System Check (Loading Screen) - Only if not already ready
    useEffect(() => {
        // Skip health check if system is already ready
        if (systemReady) {
            return;
        }
        ...
        if (!systemReady && !healthCheckIntervalRef.current) {
            healthCheckIntervalRef.current = setInterval(checkHealth, 1000);
        }
